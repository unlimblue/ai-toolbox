...
# =============================================================================
# Discord ID to Bot ID Mapping
# =============================================================================

DISCORD_ID_TO_BOT_ID = {
    "1477314385713037445": "chengxiang",  # 丞相
    "1478216774171365466": "taiwei",     # 太尉
}

BOT_ID_TO_DISCORD_ID = {v: k for k, v in DISCORD_ID_TO_BOT_ID.items()}


# =============================================================================
# Role ID to Bot ID Mapping (for role mentions)
# =============================================================================

ROLE_ID_TO_BOT_ID = {
    "1477314769764614239": "chengxiang",  # 丞相角色ID
    "1478217215936430092": "taiwei",     # 太尉角色ID
}
